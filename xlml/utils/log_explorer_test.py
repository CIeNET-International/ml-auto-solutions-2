...
class LogExplorerTest(parameterized.TestCase, absltest.TestCase):
  ...
  #   result = log_explorer.list_log_entries(
  ...
  #       )
  #   else:
  #     result = log_explorer.validate_gcs_checkpoint_save(
  #         project_id=project_id,
  #         location=location,
  #         cluster_name=cluster_name,
  #         bucket_name=bucket_name,
  ...
  #         mock_AirflowFailException, expected_exception_message
  #     ):
  #       log_explorer.validate_log_with_step(
  #           project_id=project_id,
  #           location=location,
  #           cluster_name=cluster_name,
  ...
  #       )
  #   else:
  #     result = log_explorer.validate_log_with_step(
  #         project_id=project_id,
  #         location=location,
  #         cluster_name=cluster_name,
  #         vali_step_list=vali_step_list,
