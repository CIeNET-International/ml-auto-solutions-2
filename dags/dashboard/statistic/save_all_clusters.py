...
# --- Step 1: Config ---
BQ_CLUSTER_NAME_VIEW = "cluster_info_view_latest"
BQ_TABLE = "gke_list_clusters"
...
def get_clusters_from_view():
    ...
    query = f"""
        ...
        FROM `{BQ_PROJECT_ID}.{BQ_DATASET}.{BQ_CLUSTER_NAME_VIEW}`
    """
...
def save():
    ...
    table_ref = bq_client.dataset(BQ_DATASET, project=BQ_PROJECT_ID).table(BQ_TABLE)
