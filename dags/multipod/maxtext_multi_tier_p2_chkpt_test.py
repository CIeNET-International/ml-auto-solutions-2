...
with models.DAG(
    dag_id="maxtext_multi_tier_p2_chkpt_test",
  ...
  base_output_directory = (
      f"{gcs_bucket.ERNIE_BASE_OUTPUT_DIR}/maxtext_multi_tier_checkpointing_test"
  )
    ...
    for accelerator, slices in test_configs.items():
      for slice_num in slices:
        ...
        workload_command = (
            ...
            f"dataset_type=synthetic steps=20 per_device_batch_size=1 "
            ...
            "use_replicator_service=True replicator_backup_interval_minutes=1 "
        ...
        # cleanup_command = (f"echo {run_name}",)
