...
with models.DAG(
    dag_id="maxtext_multi_tier_checkpointing_restore_gcs",
    schedule=None,
    tags=[
        "multipod_team",
        "maxtext",
    ...
    for accelerator, slices in test_configs.items():
      for slice_num in slices:
        ...
        maxtext_v5e32_interruption = gke_config.get_gke_config(
            ...
            time_out_in_min=60,
            test_name="maxtext-multi-tier-checkpointing-phase2-initial-run-gcs",
        ...
        maxtext_v5e32_restore = gke_config.get_gke_config(
            ...
            cluster=clusters[accelerator],
            time_out_in_min=60,
            test_name="maxtext-multi-tier-checkpointing-phase2-restore-gcs",
            run_model_cmds=command,
            docker_image=image.value,
            test_owner="Camilo Quinones",
