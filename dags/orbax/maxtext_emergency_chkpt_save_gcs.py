...
with models.DAG(
    dag_id="maxtext_emergency_sav02_save_gcs",
    schedule_interval=SCHEDULE,
    tags=[
        "multipod_team",
        "maxtext",
        "multi_tier_p1_chkpt_save_gcs",
        "nightly",
    ],
    ...
    for accelerator, slices in test_configs.items():
      for slice_num in slices:
        ...
        workload_command = (
            ...
            f"reuse_example_batch=1 enable_emergency_checkpoint=true model_name={model_name} per_device_batch_size=2 "
