...
# ----------------------------
# HACKED TIME CONFIG (by dag_id)
# ----------------------------
HACKED_DAG_TIMES = {
    # Example:
    # "sample_dag": {
    #     "run": {
    #         "execution": "2025-08-10T00:00:00Z",
    #         "start": "2025-08-10T00:05:00Z",
    #         "end": "2025-08-10T01:00:00Z",
    #         "run_id": "manual__2025-08-10T00:00:00+00:00"  # optional
    #     },
    #     "tests": {
    #         "abc": {
    #             "start": "2025-08-10T00:10:00Z",
    #             "end": "2025-08-10T00:20:00Z"
    #         }
    #     }
    # }
}
